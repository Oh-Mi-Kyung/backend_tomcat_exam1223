...
//	      System.out.println(bucketName);
		...
		GetObjectRequest getObjReq = GetObjectRequest.builder().bucket(bucketName).key(key).build();
...
//	      String key2 = "dfc24615-9480-46e6-94da-e90812b88643_running.jpg";
		...
		return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, cd.toString())
				.contentType(MediaType.APPLICATION_OCTET_STREAM).contentLength(bytes.length).body(resource);
	}
}
